                         ...
                         <div class="range offset-top-15">
                          <div class="cell-xs">
                            <div class="form-group">
                              ...
                              <!--Select 2-->
                              <select data-minimum-results-for-search="Infinity" class="form-control select-filter" name="from">
                                <option value="Jakarta">Jakarta (JKT)</option>
                                <option value="2">Surabaya</option>
                                <option value="3">Jogja</option>
                                <option value="4">Bali</option>
                                <option value="5">Makasar</option>
                                <option value="6">Semarang</option>
                                <option value="7">Kalimantan</option>
                              </select>
                            </div>
                          </div>
                          <div class="cell-xs offset-top-15 offset-xs-top-0">
                            <div class="form-group">
                              ...
                              <!--Select 2-->
                              <select data-minimum-results-for-search="Infinity" class="form-control select-filter" name="to">
                          ...
                          <div class="range offset-top-15">
                            ...
                            <div class="cell-lg-clear-flex cell-sm-bottom cell-lg text-center text-lg-right offset-top-15 offset-lg-top-0">
                              <button type="submit" class="btn btn-primary btn-sm btn-naira btn-naira-up"><span class="icon fa-search"></span><span>Search Flight</span></button>
                            </div>
                          </div>
                        </div>
                      </form>
